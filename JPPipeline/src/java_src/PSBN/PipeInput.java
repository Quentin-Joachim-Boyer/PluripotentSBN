...
public class PipeInput {
    ...
    public final boolean includeWeightsAndTransitions;

    public PipeInput(Integer dim, String lp_enumeratorFile, String setup_btreeFolder, Integer nSolutions, String output_path, boolean includeWeightsAndTransitions) {
        this.dim = dim;
