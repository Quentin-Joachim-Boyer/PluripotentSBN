...
- sbn\_viz(7).html : structures et dynamiques détaillés.

- sbn\_scatter(5).html : nuages des dynamiques placées selon différentes métriques.
...
Ce stage aura aussi donné l'occasion de rédiger un article synthétisant une partie de la longue réflexion sur les SBN ?
